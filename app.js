document.write('<h3>'+ "We want to know what is your favorite game of all time we are making a poll please answer the question :) "+'</h3>');

var favGame = prompt("What is your favorite game ?");
if (favGame == "rdr2" || favGame=="Red Dead Redemption 2"){
  document.write('<h3>'+ "Your favorite game is "+ '</h3>');
