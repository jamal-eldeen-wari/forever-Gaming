...
if (favGame == "rdr2"){
  document.write('<h3 id = "middle">'+ "Your favorite game is "+ '</h3>');
  // document.write('<img src = "https://upload.wikimedia.org/wikipedia/en/4/44/Red_Dead_Redemption_II.jpg" width = "200px" class = "center" >'); 
  result = '<img src = "https://upload.wikimedia.org/wikipedia/en/4/44/Red_Dead_Redemption_II.jpg" width = "200px" class = "center" >'; 
  }else if(favGame == "fifa21"){
document.write('<h3 id = "middle">'+ "Your favorite game is "+ '</h3>');
  // document.write('<img src = "https://images-na.ssl-images-amazon.com/images/I/81mBk8%2BsxrL._AC_SX385_.jpg"width = "200px" class = "center">');
   result = '<img src = "https://images-na.ssl-images-amazon.com/images/I/81mBk8%2BsxrL._AC_SX385_.jpg"width = "200px" class = "center">';
}else if(favGame == "CODMW"){
  document.write('<h3 id = "middle">'+ "Your favorite game is " + '</h3>');
  // document.write('<img src = "https://www.callofduty.com/content/dam/atvi/callofduty/cod-touchui/kronos/common/social-share/social-share-image.jpg" width = "200px" class = "center">');
  result = '<img src = "https://www.callofduty.com/content/dam/atvi/callofduty/cod-touchui/kronos/common/social-share/social-share-image.jpg" width = "200px" class = "center">';
}else if(favGame == "CODBO"){
document.write('<h3 id = "middle">'+ "Your favorite game is "+ '</h3>');
// document.write('<img src = "https://upload.wikimedia.org/wikipedia/en/thumb/4/40/Black_Ops_Cold_War.jpeg/220px-Black_Ops_Cold_War.jpeg" width = "200px" class = "center">');
result = '<img src = "https://upload.wikimedia.org/wikipedia/en/thumb/4/40/Black_Ops_Cold_War.jpeg/220px-Black_Ops_Cold_War.jpeg" width = "200px" class = "center">';
}else if(favGame == "LoUR"){
   document.write('<h3 id = "middle">'+ "Your favorite game is "+ '</h3>');
  // document.write('<img src = "https://image.api.playstation.com/vulcan/img/rnd/202010/2716/Uf86AuvSNRplUW1tpSsYJqQX.png"width = "200px" class = "center">');
  result = '<img src = "https://image.api.playstation.com/vulcan/img/rnd/202010/2716/Uf86AuvSNRplUW1tpSsYJqQX.png"width = "200px" class = "center">';
}else if(favGame == "Uncharted" ){
  document.write('<h3 id = "middle">'+ "Your favorite game is "+ '</h3>');
  // document.write('<img src = "https://upload.wikimedia.org/wikipedia/en/1/1a/Uncharted_4_box_artwork.jpg"width = "200px" class = "center">');
  result = '<img src = "https://upload.wikimedia.org/wikipedia/en/1/1a/Uncharted_4_box_artwork.jpg"width = "200px" class = "center">';
...
result = '<img id = "stars" src = "https://upload.wikimedia.org/wikipedia/commons/thumb/9/95/Star_rating_2_of_5.png/180px-Star_rating_2_of_5.png" width = "150px" class = "center">';
}
if(rate == 3){
...
result = '<img id = "stars" src = "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4e/3_stars.svg/1024px-3_stars.svg.png" width = "150px" class = "center">';
}
...
result = '<img id = "stars" src = "https://upload.wikimedia.org/wikipedia/commons/f/fa/Star_rating_4_of_5.png" width = "150px" class = "center">';
...
result = '<img id = "stars" src = "https://upload.wikimedia.org/wikipedia/commons/thumb/1/17/Star_rating_5_of_5.png/180px-Star_rating_5_of_5.png" width = "150px" class = "center">';
}
return result
} 

function printingImagesDependingOnUserInput(){
  var result = '';
if(favGame == "rdr2"){
  for (var i = 0 ; i<rate ; i++){
result += '<img src = "https://upload.wikimedia.org/wikipedia/en/4/44/Red_Dead_Redemption_II.jpg" width = "200px" class = "center" >';
...
document.write(favgames());
document.write(rateFunc());
document.write(printingImagesDependingOnUserInput());
